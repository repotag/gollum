...
$(document).ready(function() {
  ...
  livePreview = null;
  if ($('#gollum-live-preview').length) {
    livePreview = {
      PreviewWrapper: $('#gollum-live-preview'),
      PreviewTargetSelector: '.gollum-preview-target',
      PreviewToggle: $('#gollum-editor-preview'),
      BaseUrl: baseUrl,
      FragmentsUrl: '/fragments'
    };
  }
  ...
  if( $('#wiki-wrapper.edit').length ){
    ...
    initGollumEditor(false, baseUrl, uploadDest, default_markup, livePreview);
  }
  ...
  if( $('#wiki-wrapper.create').length ){
    ...
    initGollumEditor(true, baseUrl, uploadDest, default_markup, livePreview);
  }
